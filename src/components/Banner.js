    ...
    return (
        <div className="banner">
            ...
            <div className="container-fluid banner-content">
                <h1 className="name">Ravisher Singh</h1>
                <p className="section-description">Student at University of Colorado Denver</p>
                 <a  className= "btn btn-dark btn-main" href = {Pdf} target= "_blank" rel="noreferrer">Download Resume</a>
                <Link
                ...
                <div className="social-media-buttons-group">
                    <a
                        href="https://github.com/ravishersingh2"
